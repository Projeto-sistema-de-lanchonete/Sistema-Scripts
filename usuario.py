...
def MainUsuario():
      ...
      def EditUsuario():
          ...
          # Funçao para Alterar o cadastro de usuário 
            ...
            esp_label = Label(signin_window,text="", bg="#DCDCDC")
            esp_label.grid(row=0,column=0)

            Usuario_label = Label(signin_window,text="Cod.:", bg="#DCDCDC", font="Britannic 10 bold")
            Usuario_label.grid(row=1,column=0, pady=5, padx=10) #pady e padx é o espaço ao redor

            Usuario_label = Label(signin_window,text="Usuário:", bg="#DCDCDC", font="Britannic 10 bold")
            Usuario_label.grid(row=2,column=0, pady=5, padx=10) #pady e padx é o espaço ao redor

            Cpf_label = Label(signin_window,text="CPF:", bg="#DCDCDC", font="Britannic 10 bold")
            Cpf_label.grid(row=3,column=0, pady=5, padx=10)

            Senha_label = Label(signin_window,text="Senha:", bg="#DCDCDC", font="Britannic 10 bold")
            Senha_label.grid(row=4,column=0, pady=5, padx=10)

            Texto_label = Label(signin_window,text="", fg="green", bg="#DCDCDC", font="Britannic 10 bold")
            Texto_label.grid(row=5,column=0,rowspan=20,columnspan=4,padx=20,pady=15,sticky=W+E)

            #---------entrys-----------------------------
            Id_entry = Entry(signin_window, width=10, bd=4)
            Id_entry.grid(row=1,column=1,ipady=3,sticky=W+E)

            Usuario_entry = Entry(signin_window, width=35, bd=4)
            Usuario_entry.grid(row=2,column=1,ipady=3)

            Cpf_entry = Entry(signin_window, width=35, bd=4)
            Cpf_entry.grid(row=3,column=1,ipady=3)

            Senha_entry = Entry(signin_window, width=35, bd=4)
            Senha_entry.grid(row=4,column=1,ipady=3)


            #---------buttons-----------------------------
            excluiruser = Button(signin_window,text="Pesquisar",bg="#DCDCDC", padx=20, pady=2, borderwidth=5,command=PesquisarUsuario,width=15)
      ...
      def CadastrarUsuario():
            ...
            # verificando se o usuário ou cpf ja existem----------------------
      ...
      editaruser = Button(frame3,text="Editar", bg="#C0C0C0", padx=20, pady=2, borderwidth=5, command=EditUsuario)
